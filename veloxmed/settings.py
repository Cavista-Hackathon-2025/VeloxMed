"""
Django settings for veloxmed project.
...
SECRET_KEY = 'django-insecure-@#&#b#n&_t&+44-+dc@bz2#kk1j_))-dy+@=f42*25)6)_nd-_'
...
WSGI_APPLICATION = 'veloxmed.wsgi.application'
